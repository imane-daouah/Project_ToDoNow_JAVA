...
public class ModifierSéance extends JFrame {
 
	private static final long serialVersionUID = 1L;

	public ModifierSéance() {
        setTitle("DO NOW : Modifier Séance ");
        setSize(900, 600);
        ...
        JLabel lblDescription = new JLabel("Modifier Description:");
        ...
        JLabel lblDateAjout = new JLabel("Modifier Date De Début");
        lblDateAjout.setFont(new Font("Arial", Font.BOLD, 15));

        JLabel lblImporter = new JLabel("Modifier Date De La Fin:");
        ...
        JButton btnSupprimer = new JButton("Ignorer");
        btnSupprimer.setBackground(new Color(255, 62, 62));
        JButton btnEnregistrer = new JButton("Enregistrer Les Modiffications ");
