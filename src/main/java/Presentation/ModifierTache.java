...
public class ModifierTache extends JFrame {
	...
	public ModifierTache() {
        setTitle("DO NOW : Modifier Tache");
        setSize(900, 600);
        ...
        JLabel lblCategorie = new JLabel(" Modifier Catégorie :");
        ...
        JLabel lblDateDebut = new JLabel(" Modifier Date de départ :");
        lblDateDebut.setFont(new Font("Arial", Font.BOLD, 15));

        JLabel lblDateFin = new JLabel(" Modifier Date de fin :");
