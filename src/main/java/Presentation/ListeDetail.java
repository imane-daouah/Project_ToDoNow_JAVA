...
public class ListeDetail extends JFrame {
	 
	private static final long serialVersionUID = 1L;

	public ListeDetail() {
        setTitle("DO NOW : Details Liste ");
        setSize(900, 600);
        ...
        JLabel lblDescription = new JLabel("_Détails de Cette Liste:_");
        ...
        btnModifier.addActionListener(e -> {
            dispose();  // Ferme la fenêtre actuelle
            SwingUtilities.invokeLater(() -> {
            	ModifierList att= new ModifierList();
				att.setVisible(true);  // Ouvre la fenêtre du tableau de bord
            });
        });
